...
/// <summary>
/// Descripción breve de CobroPorcientoRangoBehavior
/// </summary>
public class CobroPorcientoRangoBehavior : ICobroBehavior
{
	public CobroPorcientoRangoBehavior()
	{
		//
    ...
    public void fn_ObtenerSubTotal(Tarifa objTarifa)
    {
        ...
        // Obtener rangos
        string sQuery = "SELECT trat.valorMinimo, trat.valorMaximo, trat.iva " +
        ...
        if (arrResultado[0] == "1")
        {
            ...
            if (iEncontrado == 1)
            {
                ...
                objTarifa.dSubTotal = dResultado * objTarifa.dCantidad * decimal.Parse(objRowRango[2].ToString()) / 100;
            }
