<%@ WebHandler Language="C#" Class="h_listar" %>

using System;
using System.Web;

public class h_listar : IHttpHandler
{
    ...
    public void ProcessRequest(HttpContext context)
    {
        ...
        System.Data.SqlClient.SqlConnection(System.Configuration.ConfigurationManager.ConnectionStrings["DB_NADSI_REPConnectionString"].ConnectionString);
        conn.Open();
