...
public partial class Vista_Soportes_Referencia_soporte_referencias : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!iSessionE)
        {
            ...
            try
            {
                ...
                string[] datos = { "Inicio", "Soporte", "Cambiar estatus referencias" };
                string[] url = { "", "", "" };
    ...
    public static List<AutoComplete> fn_GeneraAutocompleteEstatusReferencia(string sCadena,int sOpcion)
    {
        // Instancia conexión.
        Conexion oConexion = new Conexion();
        List<AutoComplete> lstResultados = new List<AutoComplete>();
