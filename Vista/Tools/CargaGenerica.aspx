<%@ Page Title="" Language="C#" MasterPageFile="~/Vista/Diseno/MasterPage.master" AutoEventWireup="true" CodeFile="CargaGenerica.aspx.cs" Inherits="Vista_Tools_CargaGenerica" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" Runat="Server">
    <%@ Register Src="~/Vista/Diseno/BrearCrumbs.ascx" TagName="breadCrumbs" TagPrefix="bread" %>
    <script src="../../Scripts/Tools/js_CargaGenerica.js?v=1"></script>
</asp:Content>
